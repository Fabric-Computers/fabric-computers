...
public class Items {
    public static void init() {
        ...
        Registry.register(Registry.ITEM, new Identifier("fabriccomputers", "redstone_component"), new BlockItem(Blocks.REDSTONE_COMPONENT_BLOCK, new FabricItemSettings().group(ItemGroup.REDSTONE)));
        Registry.register(Registry.ITEM, new Identifier("fabriccomputers", "screen_component"), new BlockItem(Blocks.SCREEN_COMPONENT_BLOCK, new FabricItemSettings().group(ItemGroup.REDSTONE)));
